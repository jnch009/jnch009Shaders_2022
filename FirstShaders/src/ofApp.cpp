...
void ofApp::draw(){
    ...
    shader.setUniform4f("uvColor", glm::vec4(0.75, 0.25, 0.25, 1));
    shader.setUniform4f("uvMulColor", glm::vec4(0.75, 0.25, 0.25, 1));
    bottomLeft.draw();
...
void ofApp::keyPressed(int key){
    ofApp::updateColor(Utility::determineColor(key));
}
